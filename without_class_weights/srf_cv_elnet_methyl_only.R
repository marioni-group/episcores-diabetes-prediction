...
runInformation <- beginPipelineRun(note = 'Survival random forest with elnet-selected variables methylation only (elnet experiment timestamp: 2021_03_31_10_45_31). Train on wave 3, test on wave 1. NA covariates removed', 
