...
runInformation <- beginPipelineRun(note = 'Probit BART with lasso features 10-year survival incremental model. Probit BART timestamp: 2021_05_03_11_45_12. Variables: CpGs, age, sex, bmi, self-reported parent/sibling diabetes, self-reported hypertension. NA covariate rows removed. No class weights', 
...
bartResponse <- readRDS(paste0(runInformation[['log folder path']], 'class_bart_test_response_2021_05_03_11_45_12.rds'))
