...
bartSurvivalModel <- readRDS(paste0(runInformation[['log folder path']], 'bart_survival_model_2021_05_03_11_03_44.rds'))
...
if (runInformation[['log']]) {
  saveRDS(eventPredictions, paste0(runInformation[['log folder path']], 'bart_survival_model_from_2021_05_03_11_03_44_event_predictions_', runInformation[['start timestamp']], '.rds'))
}
