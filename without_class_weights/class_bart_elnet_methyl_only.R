...
runInformation <- beginPipelineRun(note = 'Probit BART (binary classification) with features selected with logistic elnet methylation only (experiment timestamp: 2021_03_31_10_45_31).', 
