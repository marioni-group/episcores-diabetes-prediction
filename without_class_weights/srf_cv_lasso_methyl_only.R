...
runInformation <- beginPipelineRun(note = 'Survival random forest with lasso-selected variables methylation only (lasso experiment timestamp: 2021_03_31_10_31_42). Train on wave 3, test on wave 1. NA covariates removed', 
