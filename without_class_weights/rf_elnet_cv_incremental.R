...
runInformation <- beginPipelineRun(note = 'Random Forest CV with elnet features 10-year survival incremental model. Random Forest timestamp: 2021_05_03_17_44_04. Variables: CpGs, age, sex, bmi, self-reported parent/sibling diabetes, self-reported hypertension. NA covariate rows removed. No class weights', 
...
rfResponse <- readRDS(paste0(runInformation[['log folder path']], 'random_forest_elnet_test_response_2021_05_03_17_44_04.rds'))
