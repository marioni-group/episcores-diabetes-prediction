...
runInformation <- beginPipelineRun(note = 'Probit BART with elnet features 10-year survival incremental model. Probit BART timestamp: 2021_05_03_12_10_33. Variables: CpGs, age, sex, bmi, self-reported parent/sibling diabetes, self-reported hypertension. NA covariate rows removed. No class weights', 
...
bartResponse <- readRDS(paste0(runInformation[['log folder path']], 'class_bart_test_response_2021_05_03_12_10_33.rds'))
