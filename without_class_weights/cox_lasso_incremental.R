...
runInformation <- beginPipelineRun(note = 'Cox lasso incremental model. Variables: CpGs, age, sex, bmi, self-reported parent/sibling diabetes, self-reported hypertension. NA covariate rows removed. No class weights. Fit methyl model on wave 3.', 
