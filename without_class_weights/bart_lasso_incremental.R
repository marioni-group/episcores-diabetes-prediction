...
runInformation <- beginPipelineRun(note = 'BART with lasso features 10-year survival incremental model. Variables: CpGs, age, sex, bmi, self-reported parent/sibling diabetes, self-reported hypertension. NA covariate rows removed. No class weights', 
...
bartResponse <- readRDS(paste0(runInformation[['log folder path']], 'bart_survival_model_from_2021_03_29_12_12_56_event_predictions_2021_03_29_18_31_18.rds'))
