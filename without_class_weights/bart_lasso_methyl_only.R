...
runInformation <- beginPipelineRun(note = 'BART survival model - features selected with logistic lasso (methylation only, no class weights), rows with na covariates removed (timestamp: 2021_03_29_11_54_07). Train on wave 3', 
