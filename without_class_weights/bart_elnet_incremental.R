...
runInformation <- beginPipelineRun(note = 'BART with elnet features 10-year survival incremental model. Variables: CpGs, age, sex, bmi, self-reported parent/sibling diabetes, self-reported hypertension. NA covariate rows removed. No class weights', 
...
bartResponse <- readRDS(paste0(runInformation[['log folder path']], 'bart_survival_model_from_2021_05_03_11_03_44_event_predictions_2021_05_03_16_07_53.rds'))
