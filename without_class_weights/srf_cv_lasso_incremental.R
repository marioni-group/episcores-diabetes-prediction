...
runInformation <- beginPipelineRun(note = 'Survival Random Forest CV with lasso features 10-year survival incremental model. Survival Random Forest timestamp: 2021_05_05_01_13_54. Variables: CpGs, age, sex, bmi, self-reported parent/sibling diabetes, self-reported hypertension. NA covariate rows removed. No class weights', 
...
srfResponse <- readRDS(paste0(runInformation[['log folder path']], 'survival_random_forest_test_response_2021_05_05_01_13_54.rds'))
