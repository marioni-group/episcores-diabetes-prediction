...
runInformation <- beginPipelineRun(note = 'Random Forest CV with lasso features 10-year survival incremental model. Random Forest timestamp: 2021_05_04_13_31_59. Variables: CpGs, age, sex, bmi, self-reported parent/sibling diabetes, self-reported hypertension. NA covariate rows removed. With class weights', 
...
rfResponse <- readRDS(paste0(runInformation[['log folder path']], 'random_forest_lasso_test_response_2021_05_04_13_31_59.rds'))
