...
runInformation <- beginPipelineRun(note = 'Probit BART (binary classification) with features selected with logistic lasso methylation only with class weights (experiment timestamp: 2021_04_01_13_03_03. Rerun with serialize = TRUE to calculate diagnostics).', 
