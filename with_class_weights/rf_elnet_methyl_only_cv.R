...
runInformation <- beginPipelineRun(note = 'Random forest with elnet-selected variables, methylation only (Experiment timestamp: 2021_04_01_13_22_48. With class weights). Train on wave 3, test on wave 1.', 
