...
bartSurvivalModel <- readRDS(paste0(runInformation[['log folder path']], 'bart_survival_model_2021_04_25_14_24_45.rds'))
...
if (runInformation[['log']]) {
  saveRDS(eventPredictions, paste0(runInformation[['log folder path']], 'bart_survival_model_from_2021_04_25_14_24_45_event_predictions_', runInformation[['start timestamp']], '.rds'))
}
