...
runInformation <- beginPipelineRun(note = 'Survival random forest with elnet-selected variables methylation only, with weights (elnet experiment timestamp: 2021_04_01_13_22_48). Train on wave 3, test on wave 1. NA covariates removed', 
