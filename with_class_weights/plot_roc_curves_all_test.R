...
lassoResponse <- readRDS(paste0(runInformation[['log folder path']], 'test_response_logistic_model_predictions_2021_03_09_12_25_07.rds'))
elnetResponse <- readRDS(paste0(runInformation[['log folder path']], 'test_response_logistic_model_predictions_2021_03_09_11_50_27.rds'))
ridgeResponse <- readRDS(paste0(runInformation[['log folder path']], 'test_response_logistic_model_predictions_2021_03_09_12_38_54.rds'))
lassoNullResponse <- readRDS(paste0(runInformation[['log folder path']], 'test_response_logistic_model_predictions_2021_03_09_12_49_53.rds'))
bartSurvivalResponse <- readRDS(paste0(runInformation[['log folder path']], 'bart_survival_model_from_2021_03_09_12_46_21_event_predictions_test_2021_03_18_17_46_38.rds'))
srfResponse <- readRDS(paste0(runInformation[['log folder path']], 'survival_random_forest_test_response_2021_03_18_11_49_31.rds'))
coxElnetResponse <- readRDS(paste0(runInformation[['log folder path']], 'cox_elnet_onset_predictions_test_2021_03_16_10_13_40.rds'))

methods <- c('cox_elnet', 'logistic_lasso_null', 'logistic_elnet', 'logistic_lasso', 'survival_bart', 'survival_random_forest')
responses <- list(coxElnetResponse, lassoNullResponse, elnetResponse, lassoResponse, bartSurvivalResponse, srfResponse)
...
calibrationResult <- caret::calibration(actual ~ logistic_lasso + logistic_elnet + logistic_lasso_null + survival_bart + survival_random_forest + cox_elnet,
                                        data = calibrationDF)
