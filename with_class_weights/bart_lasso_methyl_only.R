...
runInformation <- beginPipelineRun(note = 'BART survival model - features selected with logistic lasso (methylation only, with class weights), rows with na covariates removed (timestamp: 2021_04_01_13_03_03). Train on wave 3', 
