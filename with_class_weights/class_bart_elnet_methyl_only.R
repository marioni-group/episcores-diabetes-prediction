...
runInformation <- beginPipelineRun(note = 'Probit BART (binary classification) with features selected with logistic elnet methylation only with class weights (experiment timestamp: 2021_04_01_13_22_48).', 
